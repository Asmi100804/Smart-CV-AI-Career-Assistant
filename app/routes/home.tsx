...
const iconStylesByFeature = {
  ...
  'ai-mock-test': 'from-orange-400 to-rose-600',
} as const;
...
const iconPathsByFeature = {
  ...
  'ai-mock-test': 'M9 17v-2a4 4 0 014-4h7m0 0l-3-3m3 3l-3 3M4 5h16M4 9h10M4 13h6',
} as const;
...
export default function Home() {
  ...
  return <main className='bg-linear-to-br from-blue-50 via-purple-50 to-pink-50 min-h-screen'>
    ...
    <section className='main-section'>
      ...
      <div className='w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-12'>
